...
const lesson1_2: I18nLessonContent = {
  ...
  content: [
    ...
    { type: "miniCheck", question: { en: "What is the FIRST step of a risk assessment?", ro: "Care este PRIMUL pas al unei evaluări de risc?" }, options: [{ en: "Write a method statement", ro: "Scrieți o declarație de metodă" }, { en: "Identify the hazards", ro: "Identificați pericolele" }, { en: "Put up safety signs", ro: "Montați semne de siguranță" }, { en: "Buy PPE for workers", ro: "Cumpărați EIP pentru muncitori" }], correct: 1, feedback: { en: "Correct! Step 1 is ALWAYS to identify the hazards. You can't manage risks if you don't know what the hazards are.", ro: "Corect! Pasul 1 este ÎNTOTDEAUNA identificarea pericolelor. Nu puteți gestiona riscuri fără a cunoaște pericolele." } },
...
const lesson1_4: I18nLessonContent = {
  ...
  content: [
    ...
    { type: "miniCheck", question: { en: "Under RIDDOR, an injury must be reported if a worker is off work for more than:", ro: "Conform RIDDOR, o rănire trebuie raportată dacă un muncitor lipsește de la muncă mai mult de:" }, options: [{ en: "1 day", ro: "1 zi" }, { en: "3 days", ro: "3 zile" }, { en: "7 days", ro: "7 zile" }, { en: "14 days", ro: "14 zile" }], correct: 2, feedback: { en: "Correct! Under RIDDOR, injuries that keep a worker off for MORE THAN 7 DAYS must be reported to the HSE.", ro: "Corect! Conform RIDDOR, rănirile care țin un muncitor acasă MAI MULT DE 7 ZILE trebuie raportate la HSE." } },
...
const lesson1_7: I18nLessonContent = {
  ...
  content: [
    ...
    { type: "miniCheck", question: { en: "What voltage should portable electrical equipment use on a construction site?", ro: "Ce tensiune trebuie să folosească echipamentele electrice portabile pe un șantier?" }, options: [{ en: "230V", ro: "230V" }, { en: "110V", ro: "110V" }, { en: "415V", ro: "415V" }, { en: "12V", ro: "12V" }], correct: 1, feedback: { en: "Correct! 110V (yellow plugs) is the safe voltage for construction sites. 230V mains voltage can kill.", ro: "Corect! 110V (prize galbene) este tensiunea sigură pentru șantiere. 230V poate ucide." } },
...
const lesson1_8: I18nLessonContent = {
  ...
  content: [
    ...
    { type: "miniCheck", question: { en: "What is the main cause of occupational dermatitis on construction sites?", ro: "Care este cauza principală a dermatitei profesionale pe șantierele de construcții?" }, options: [{ en: "Wearing a hard hat", ro: "Purtarea căștii" }, { en: "Contact with substances like cement, solvents, and oils", ro: "Contactul cu substanțe precum cimentul, solvenții și uleiurile" }, { en: "Working in sunlight", ro: "Lucrul în lumina soarelui" }, { en: "Using hand tools", ro: "Folosirea sculelor de mână" }], correct: 1, feedback: { en: "Correct! Dermatitis is caused by skin contact with substances like wet cement, solvents, oils, and chemicals. Wear gloves and wash hands.", ro: "Corect! Dermatita este cauzată de contactul pielii cu substanțe precum cimentul umed, solvenții, uleiurile și chimicalele. Purtați mănuși și spălați-vă pe mâini." } },
