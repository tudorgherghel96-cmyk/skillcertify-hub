...
const lesson2_1: I18nLessonContent = {
  ...
  content: [
    ...
    { type: "miniCheck", conceptSlug: "injury_types_msk", question: { en: "What is the MOST COMMON injury caused by manual handling?", ro: "Care este cea mai FRECVENTĂ accidentare cauzată de manipularea manuală?" }, options: [{ en: "Broken arm", ro: "Braț rupt" }, { en: "Lower back injury", ro: "Leziune la spatele inferior" }, { en: "Head injury", ro: "Leziune la cap" }, { en: "Ankle sprain", ro: "Entorsă de gleznă" }], correct: 1, feedback: { en: "Correct! Lower back injury is the most common manual handling injury. This is why correct lifting technique is so important.", ro: "Corect! Leziunea la spatele inferior este cea mai frecventă accidentare din manipularea manuală. De aceea tehnica corectă de ridicare este atât de importantă." } },
