...
const lesson3_1: I18nLessonContent = {
  ...
  content: [
    ...
    { type: "miniCheck", conceptSlug: "fall_prevention_vs_fall_arrest", question: { en: "A safety harness is the ___ resort for fall protection.", ro: "Un ham de siguranță este ___ recurs pentru protecția împotriva căderilor." }, options: [{ en: "First", ro: "Primul" }, { en: "Second", ro: "Al doilea" }, { en: "Last", ro: "Ultimul" }, { en: "Only", ro: "Singurul" }], correct: 2, feedback: { en: "Correct! A harness is the LAST resort. Always try to AVOID height work first, then PREVENT falls with guardrails, then minimise with harnesses.", ro: "Corect! Un ham este ULTIMUL recurs. Încercați întotdeauna mai întâi să EVITAȚI lucrul la înălțime, apoi PREVENIȚI căderile cu balustrade, apoi minimizați cu hamuri." } },
...
const lesson3_2: I18nLessonContent = {
  ...
  content: [
    ...
    { type: "miniCheck", conceptSlug: "ladder_safety_requirements", question: { en: "Three points of contact on a ladder means:", ro: "Trei puncte de contact pe scară înseamnă:" }, options: [{ en: "Three hands on the ladder", ro: "Trei mâini pe scară" }, { en: "Two hands + one foot, or two feet + one hand", ro: "Două mâini + un picior, sau două picioare + o mână" }, { en: "Both feet + both hands", ro: "Ambele picioare + ambele mâini" }, { en: "One hand + one foot", ro: "O mână + un picior" }], correct: 1, feedback: { en: "Correct! 3 points of contact = 2 hands and 1 foot, or 2 feet and 1 hand on the ladder at all times.", ro: "Corect! 3 puncte de contact = 2 mâini și 1 picior, sau 2 picioare și 1 mână pe scară în orice moment." } },
...
const lesson3_3: I18nLessonContent = {
  ...
  content: [
    ...
    { type: "miniCheck", conceptSlug: "inspection_requirements", question: { en: "When must scaffolding be inspected? (Select the BEST answer)", ro: "Când trebuie inspectate schelele? (Selectați cel mai bun răspuns)" }, options: [{ en: "Only once a week", ro: "Doar o dată pe săptămână" }, { en: "Before each shift and after bad weather", ro: "Înainte de fiecare schimb și după vreme rea" }, { en: "Only when it looks damaged", ro: "Doar când pare deteriorată" }, { en: "Monthly", ro: "Lunar" }], correct: 1, feedback: { en: "Correct! Before EVERY shift and after bad weather. This is a common test question.", ro: "Corect! Înainte de FIECARE schimb și după vreme rea. Aceasta este o întrebare frecventă la test." } },
