...
export default function Journey() {
  ...
  const milestones: Array<{
    ...
    {
      title: "Complete each course topic",
      icon: BookOpen,
      status: st(allLessonsDone, true),
      progressText: `${completedLessons}/${totalLessons} lessons done`,
      ...
      details: {
        ...
        whatsNext: "Once done, you take the assessment tests.",
      },
    },
    {
      title: "Pass each assessment test",
      icon: ClipboardCheck,
      status: st(allGqa, allLessonsDone),
      ...
      details: {
        whatYouDo: "Pass all 5 topic assessment tests. 80% pass mark needed for each.",
        whatYouNeed: "Complete the course topics first. Retake as many times as you need.",
        whyMatters: "These are the formal tests that count toward your Level 1 qualification.",
        whatsNext: "Pass all 5 and your Level 1 certificate is issued.",
      },
    },
    {
      title: "Get Level 1 certificate",
      icon: Award,
      status: allGqa ? "issued" : allLessonsDone ? "awaiting_verification" : "locked",
      progressText: allGqa ? "Verified" : undefined,
      timeEstimate: "As fast as 1 day",
      ...
      details: {
        ...
        whatYouNeed: "All 5 assessment tests must be passed.",
    ...
    },
    {
      ...
      details: {
        ...
        whatYouNeed: "Level 1 certificate verified. Book via CITB.",
        whyMatters: "Passing this test is the last step before your card.",
        whatsNext: "Pass and you can get your Green Card.",
      },
    },
    {
      title: "Get the Green Card",
      icon: CreditCard,
      status: cscsPassed ? "complete" : "locked",
      timeEstimate: "As fast as next day digitally",
      ctaLabel: cscsPassed ? "Track card" : undefined,
      onCtaClick: cscsPassed ? () => setSubView("greencard") : undefined,
      details: {
        whatYouDo: "Same-day processing. No test centre visit needed — fully online.",
        whatYouNeed: "Passed CSCS test + Level 1 verified.",
        whyMatters: "Your Green Card proves you can work on UK construction sites.",
        whatsNext: "Physical card can take up to 5 working days to reach home.",
      },
    },
  ];
