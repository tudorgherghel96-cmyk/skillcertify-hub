...
-- Buckets: lesson-images | lesson-videos (TWO buckets only)
...
('1.1', 1, 4, 'image', '1.1_photo_1.webp', 'lesson-images', '{"caption":"Trailing cables — a common site hazard"}', NULL, NULL, 0),
...
('1.1', 1, 7, 'image', '1.1_photo_2.webp', 'lesson-images', '{"caption":"Can you spot the hazards?"}', NULL, NULL, 0),
...
('1.1', 1, 11, 'image', '1.1_photo_4.webp', 'lesson-images', '{"caption":"Multiple hazards in one scene"}', NULL, NULL, 0),
...
('1.2', 1, 7, 'image', '1.2_photo_2.webp', 'lesson-images', '{"caption":"A completed risk assessment form"}', NULL, NULL, 0),
...
('1.3', 1, 7, 'image', '1.3_photo_2.webp', 'lesson-images', '{"caption":"A method statement in practice"}', NULL, NULL, 0),
...
('1.4', 1, 7, 'image', '1.4_photo_1.webp', 'lesson-images', '{"caption":"Changing conditions require reassessment"}', NULL, NULL, 0),
...
('1.5', 1, 7, 'image', '1.5_photo_2.webp', 'lesson-images', '{"caption":"The accident book — every incident recorded"}', NULL, NULL, 0),
...
('1.6', 1, 7, 'image', '1.6_photo_1.webp', 'lesson-images', '{"caption":"Construction site safety signs"}', NULL, NULL, 0),
...
('1.7', 1, 9, 'image', '1.7_photo_1.webp', 'lesson-images', '{"caption":"Fire extinguisher types — know the colours"}', NULL, NULL, 0),
...
('1.7', 1, 14, 'image', '1.7_photo_4.webp', 'lesson-images', '{"caption":"PPE — the LAST line of defence"}', NULL, NULL, 0),
...
('1.8', 1, 5, 'image', '1.8_photo_2.webp', 'lesson-images', '{"caption":"Welfare facilities on site"}', NULL, NULL, 0),
...
-- NOTE: hero-M2-L1 MISSING — using 2.1_photo_1.webp as temporary hero
-- NOTE: M2-L1-C06-point-down.mp4 MISSING — point-down excluded
-- ============================================================
INSERT INTO lesson_cards (lesson_id, module_id, card_position, card_type, media_file, media_bucket, content_json, fourth_wall_effect, effect_overlay_text, xp_value) VALUES
('2.1', 2, 1, 'hero', '2.1_photo_1.webp', 'lesson-images', '{"title":"What is Manual Handling","subtitle":"Module 2 of 5","duration":"~4 min"}', NULL, NULL, 0),
...
('2.1', 2, 9, 'image', '2.1_photo_2.webp', 'lesson-images', '{"caption":"Manual handling includes pushing and pulling"}', NULL, NULL, 0),
...
('2.2', 2, 7, 'image', '2.2_photo_3.webp', 'lesson-images', '{"caption":"Correct lifting technique in practice"}', NULL, NULL, 0),
...
-- Non-standard filenames: M2-L3-C03-teach-testples.mp4 and M2-L3-C04-lean-in-test.mp4
-- ============================================================
INSERT INTO lesson_cards (lesson_id, module_id, card_position, card_type, media_file, media_bucket, content_json, fourth_wall_effect, effect_overlay_text, xp_value) VALUES
...
('2.3', 2, 7, 'image', '2.3_photo_1.webp', 'lesson-images', '{"caption":"Assess the environment before lifting"}', NULL, NULL, 0),
...
('2.4', 2, 7, 'image', '2.4_photo_1.webp', 'lesson-images', '{"caption":"Mechanical aids reduce manual handling risk"}', NULL, NULL, 0),
...
('3.1', 3, 5, 'image', '3.1_photo_1.webp', 'lesson-images', '{"caption":"Even a stepladder counts as working at height"}', NULL, NULL, 0),
...
-- NOTE: M3-L2-C05-close.mp4 MISSING
-- ============================================================
INSERT INTO lesson_cards (lesson_id, module_id, card_position, card_type, media_file, media_bucket, content_json, fourth_wall_effect, effect_overlay_text, xp_value) VALUES
...
('3.2', 3, 5, 'remember_this', NULL, NULL, '{"text":"1:4 RULE: Every 4m up, base 1m out. 75 degrees angle. 3 points of contact always. Height divided by 4 = base distance."}', NULL, NULL, 5),
('3.2', 3, 6, 'image', '3.2_photo_2.webp', 'lesson-images', '{"caption":"The correct 1:4 ladder angle"}', NULL, NULL, 0),
('3.2', 3, 7, 'video', 'M3-L2-C03-lean-in-calculation.mp4', 'lesson-videos', '{}', 'lean_in', 'Height divided by 4 = base distance. 8m divided by 4 = 2m.', 0),
('3.2', 3, 8, 'video', 'M3-L2-C04-point-down.mp4', 'lesson-videos', '{}', 'point_down', NULL, 0),
('3.2', 3, 9, 'quick_check', NULL, NULL, '{"question":"Ladder reaches 8m. Base distance from wall?","options":["1 metre","2 metres","3 metres","4 metres"],"correct":1,"feedback_correct":"Correct! 8 divided by 4 = 2.","feedback_wrong":{"0":"Too close.","2":"Too far.","3":"Way too far."}}', NULL, NULL, 10),
('3.2', 3, 10, 'lesson_complete', NULL, NULL, '{"next_lesson":"3.3","next_title":"Scaffolding Safety"}', NULL, NULL, 5);

-- ============================================================
-- LESSON 3.3 — SCAFFOLDING
-- NOTE: M3-L3-C05-close.mp4 and M3-L3-BR01-scaffold-inspection.mp4 MISSING
-- ============================================================
INSERT INTO lesson_cards (lesson_id, module_id, card_position, card_type, media_file, media_bucket, content_json, fourth_wall_effect, effect_overlay_text, xp_value) VALUES
...
('3.3', 3, 5, 'image', '3.3_photo_2.webp', 'lesson-images', '{"caption":"Properly erected scaffold with all components"}', NULL, NULL, 0),
...
-- NOTE: M3-L4-C03-lean-in-fatal.mp4 MISSING
-- ============================================================
INSERT INTO lesson_cards (lesson_id, module_id, card_position, card_type, media_file, media_bucket, content_json, fourth_wall_effect, effect_overlay_text, xp_value) VALUES
...
('3.4', 3, 5, 'image', '3.4_photo_2.webp', 'lesson-images', '{"caption":"Rooflights — they look solid but will not hold your weight"}', NULL, NULL, 0),
...
-- NOTE: M3-L5-C01-hook-choice.mp4 MISSING — sequence starts at teach card
-- ============================================================
INSERT INTO lesson_cards (lesson_id, module_id, card_position, card_type, media_file, media_bucket, content_json, fourth_wall_effect, effect_overlay_text, xp_value) VALUES
...
-- ============================================================
-- LESSON 4.1 — COSHH
-- NOTE: M4-L1-C02-teach-coshh.mp4 and M4-L1-BR01-chemical-labels.mp4 MISSING
-- ============================================================
INSERT INTO lesson_cards (lesson_id, module_id, card_position, card_type, media_file, media_bucket, content_json, fourth_wall_effect, effect_overlay_text, xp_value) VALUES
...
('4.1', 4, 6, 'image', '4.1_photo_1.webp', 'lesson-images', '{"caption":"COSHH hazard symbols — know what they mean"}', NULL, NULL, 0),
...
-- ============================================================
-- LESSON 4.2 — ASBESTOS
-- NOTE: M4-L2-C02-teach-diseases.mp4 MISSING
-- ============================================================
INSERT INTO lesson_cards (lesson_id, module_id, card_position, card_type, media_file, media_bucket, content_json, fourth_wall_effect, effect_overlay_text, xp_value) VALUES
...
('4.2', 4, 4, 'image', '4.2_photo_2.webp', 'lesson-images', '{"caption":"Asbestos warning signage"}', NULL, NULL, 0),
...
-- NOTE: hero-M4-L3 MISSING — using 4.3_photo_3.webp as temporary hero
-- NOTE: M4-L3-C02-teach-noise-havs.mp4 MISSING
-- ============================================================
INSERT INTO lesson_cards (lesson_id, module_id, card_position, card_type, media_file, media_bucket, content_json, fourth_wall_effect, effect_overlay_text, xp_value) VALUES
('4.3', 4, 1, 'hero', '4.3_photo_3.webp', 'lesson-images', '{"title":"Noise and Vibration","subtitle":"Module 4 of 5","duration":"~3 min"}', NULL, NULL, 0),
...
('4.3', 4, 5, 'image', '4.3_photo_4.webp', 'lesson-images', '{"caption":"Hearing protection and vibration awareness"}', NULL, NULL, 0),
...
('4.4', 4, 4, 'remember_this', NULL, NULL, '{"text":"Silica dust causes Silicosis. Cement causes Dermatitis/burns. Water suppression for dust. Wash immediately for cement. NEVER dry sweep."}', NULL, NULL, 5),
...
('5.1', 5, 6, 'image', '5.1_photo_1.webp', 'lesson-images', '{"caption":"Banksman in action — clear hand signals"}', NULL, NULL, 0),
...
('5.2', 5, 5, 'image', '5.2_photo_1.webp', 'lesson-images', '{"caption":"Lock-out tag-out in practice"}', NULL, NULL, 0),
