      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          },
          {
            ...
            urlPattern: /^https:\/\/.*\.supabase\.co\/storage\/v1\/object\/public\/(lesson-images|lesson-videos|final-correct-media)\/.*\.(webp|png|jpg|jpeg)$/i,
            handler: "CacheFirst",
            options: {
          ...
          },
          {
            ...
            urlPattern: /^https:\/\/.*\.supabase\.co\/storage\/v1\/object\/public\/(lesson-images|lesson-videos|final-correct-media)\/.*\.(mp4|webm)$/i,
            handler: "CacheFirst",
            options: {
